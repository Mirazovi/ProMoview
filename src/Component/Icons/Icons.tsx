...
export function SearchIcons(props: SVGProps<SVGSVGElement>) {
  ...
  export function SunThemeIcons(props: SVGProps<SVGSVGElement>) {
    return (
...
export function ProfileIcons(props: SVGProps<SVGSVGElement>) {
    return (
  ...
  export function InstagramIcons(props: SVGProps<SVGSVGElement>) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>{/* Icon from Lucide by Lucide Contributors - https://github.com/lucide-icons/lucide/blob/main/LICENSE */}<g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8A4 4 0 0 1 16 11.37m1.5-4.87h.01"></path></g></svg>
    )
  }

  export function FacebookIcons(props: SVGProps<SVGSVGElement>) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="1em" viewBox="0 0 320 512" {...props}>{/* Icon from Font Awesome Brands by Dave Gandy - https://creativecommons.org/licenses/by/4.0/ */}<path fill="currentColor" d="M80 299.3V512h116V299.3h86.5l18-97.8H196v-34.6c0-51.7 20.3-71.5 72.7-71.5c16.3 0 29.4.4 37 1.2V7.9C291.4 4 256.4 0 236.2 0C129.3 0 80 50.5 80 159.4v42.1H14v97.8z"></path></svg>
    )
  }

  export function TwitterIcons(props: SVGProps<SVGSVGElement>) {
    return (
  ...
  export function YoutubeIcons(props: SVGProps<SVGSVGElement>) {
    return (
  ...
  export function PlayIcons(props: SVGProps<SVGSVGElement>) {
    return (
